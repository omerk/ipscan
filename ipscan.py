import os, platform, subprocess, threading, time, urllib
...
class nbtstat_thread(threading.Thread):
...
if __name__ == '__main__':
	...
	if platform.system() == "Windows":
		...
		for r in ping_results:
			nbtstat_threads.append(nbtstat_thread(r[0]))
		
		# Query Netbios names
		print "Resolving Netbios Names..."
		[t.start() for t in nbtstat_threads]
		# Wait for completion
		[t.join() for t in nbtstat_threads]
